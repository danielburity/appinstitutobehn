...
const LandingPage = () => {
    ...
    const platformBullets = [
        settings.platformBullet1,
        settings.platformBullet2,
        settings.platformBullet3,
        settings.platformBullet4,
    ].filter(Boolean);

    const pricingBenefits = [
        settings.pricingBenefit1,
        settings.pricingBenefit2,
        settings.pricingBenefit3,
        settings.pricingBenefit4,
        settings.pricingBenefit5,
    ].filter(Boolean);
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/3 w-[600px] h-[600px] bg-secondary/5 rounded-full blur-[100px] pointer-events-none" />
            </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-8">
                            <h2 className="text-4xl md:text-6xl font-black text-primary leading-tight whitespace-pre-line">
                                {settings.platformTitle}
                            </h2>
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                {settings.platformSubtitle}
                            </p>

                            <ul className="space-y-4">
                                {platformBullets.map((item, i) => (
                        ...
                        <div className="flex-1 relative">
                            ...
                            <div className="absolute -top-10 -right-10 w-40 h-40 gradient-accent rounded-full blur-3xl opacity-20 animate-pulse" />
                            <div className="absolute -bottom-10 -left-10 w-40 h-40 gradient-primary rounded-full blur-3xl opacity-20 animate-pulse" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="precos" className="py-24 gradient-primary relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-xl mx-auto text-center text-white space-y-6 mb-16">
                        <h2 className="text-4xl md:text-5xl font-black italic">{settings.pricingSectionTitle}</h2>
                        <p className="opacity-90 font-medium">{settings.pricingSectionSubtitle}</p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center bg-background rounded-[40px] shadow-2xl overflow-hidden border border-white/10">
                        ...
                        <div className="p-12 lg:p-16 bg-muted/30 space-y-8">
                            <div className="space-y-4">
                                <span className="px-4 py-1.5 bg-primary/10 text-primary rounded-full text-xs font-black tracking-widest uppercase">
                                    {settings.pricingBadge}
                                </span>
                                <h3 className="text-4xl font-black tracking-tighter">{settings.pricingPlanName}</h3>
                                <p className="text-muted-foreground font-medium text-lg leading-relaxed">
                                    {settings.pricingPlanDesc}
                                </p>
                            </div>

                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-bold text-primary">R$</span>
                                <span className="text-7xl font-black tracking-tighter text-primary">{settings.pricingValue}</span>
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-xl">
                                <span className="text-sm font-black text-primary">{settings.pricingInstallments}</span>
                            </div>
                        ...
                        <div className="p-12 lg:p-16 space-y-8">
                            <div className="text-center space-y-2 mb-4">
                                <h4 className="text-2xl font-black">{settings.pricingFormTitle}</h4>
                                <p className="text-muted-foreground text-sm font-medium">{settings.pricingFormSubtitle}</p>
                            </div>
                            <CheckoutForm />
                        </div>
                    </div>
