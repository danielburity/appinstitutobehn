...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  subscriptionPrice: "R$ 1.800,00",
  subscriptionInstallments: "ou 12× de R$ 150,00",
  subscriptionBenefit1: "Acesso a todos os cursos",
  subscriptionBenefit2: "Certificados inclusos",
  subscriptionBenefit3: "Suporte prioritário",
  subscriptionBenefit4: "Material didático digital",
  subscriptionBenefit5: "Acesso vitalício",
  subscriptionBenefit6: "Grupo exclusivo de alunos",
  subscriptionMonthlyPrice: "150,00",
  subscriptionMonthlyPlanId: "",
  footerTagline: "Transformando o conhecimento em evolução humana através da neurociência aplicada.",
