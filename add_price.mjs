...
const supabase = createClient(supabaseUrl, supabaseKey); // This is ANON KEY, won't be able to ALTER TABLE directly. Wait, can I use postgrest for altering? No, alter table is DDL.
